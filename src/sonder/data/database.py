...
class DatabaseProtocol(Protocol):
    ...
    def fetchall(self, query: str, parameters: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
        """Fetch all results from a query."""
        ...
    
    def fetchone(self, query: str, parameters: Optional[Dict[str, Any]] = None) -> Optional[Dict[str, Any]]:
...
class DuckDBAdapter(DatabaseAdapter):
    ...
    def __init__(self, database_path: Union[str, Path] = "sonder.db", **kwargs):
...
class DatabaseManager:
    ...
    def log_entity_spawn(self, entity_id: int, entity_type: str, x: int, y: int) -> None:
    ...
    def log_game_event(self, event_type: str, entity_id: Optional[int] = None, 
                      x: Optional[int] = None, y: Optional[int] = None, 
                      data: Optional[Dict[str, Any]] = None, tick_count: int = 0) -> None:
        """Log a game event."""
        import json
...
def create_database_manager(database_type: str = "duckdb", **kwargs) -> DatabaseManager:
...
def init_database(database_path: Optional[Union[str, Path]] = None) -> DatabaseManager:
...
def main():
    ...
    try:
        ...
        print(f"Database initialized successfully at: {Path(database_path).resolve()}")
        manager.close()
    except Exception as e:
